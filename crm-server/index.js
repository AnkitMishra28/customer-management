...
// JWT - MOVED OUTSIDE run() so it always works
...
// LOGOUT - MOVED OUTSIDE run() so it always works
...
async function run() {
  ...
  app.get("/manageLead",async(req,res)=>{
    ...
    app.patch("/api/tasks/:id", varifyToken, verifyAdmin, async (req, res) => {
      const { status } = req.body;
    ...
    app.patch("/api/followups/:id", varifyToken, verifyAdmin, async (req, res) => {
      const { id } = req.params;
      const { status } = req.body;
    ...
    app.patch("/api/leads/:id", varifyToken, verifyAdmin, async (req, res) => {
